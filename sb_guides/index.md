...
To begin with, collect 100 red orbs on the horserider's spear tip. Jump onto the horse from the stairs first of all, and then hop-jump again onto its neck (if the first jump didn't get you there). From the neck, there are two ways of getting on top of the spear. The first way is to stand next to the spear, do a full jump straight up, then press Triangle to do a kick-jump onto the tip. The second way is to hold down Triangle (you can't stop Dante from doing an initial jump first), and then walk around the base of the neck with Triangle held down - there is a trigger point which, if you pass over it, will make Dante automatically jump to grab the tip and haul himself onto it. You don't want to be messing around for 5 minutes trying to land on the spear tip, so practice for a while and find the method which you can do fastest.
